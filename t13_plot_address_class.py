...
# %%
df = pd.read_excel('address_year_count_mean_ci_95.xlsx',index_col=0)
df
...
# 调整图例位置
bax.legend(loc='upper left', bbox_to_anchor=(0.3, 1), frameon=False)


plt.savefig('address_year_count_mean_ci_95.png', dpi=300, bbox_inches='tight')
#plt.tight_layout()
plt.show()
...
# %%
df = pd.read_excel('address_first_year_count_mean_ci_95.xlsx',index_col=0)
df
...
plt.tight_layout()
plt.savefig('address_first_year_count_mean_ci_95.png', dpi=300, bbox_inches='tight')
plt.show()


# %%
df = pd.read_excel('address_AI_sum_year.xlsx')
df
...
# 自动调整布局
fig.tight_layout()
plt.savefig('address_AI_sum_year.png', dpi=300, bbox_inches='tight')
plt.show()


# %%
df = pd.read_excel('address_first_AI_sum_year.xlsx')
df
...
# 自动调整布局
fig.tight_layout()
plt.savefig('address_first_AI_sum_year.png', dpi=300, bbox_inches='tight')
plt.show()
