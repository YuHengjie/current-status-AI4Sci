...
plt.tight_layout()
plt.savefig('ai_publication_count_bar.png', dpi=300, bbox_inches='tight')
plt.show()
...
# 使用curve_fit来拟合指数函数
params, covariance = curve_fit(exp_func, x_data, data['AI publications'])
...
plt.tight_layout()
plt.savefig('ai_publication_count_bar_with_smooth_curve.png', dpi=300, bbox_inches='tight')
plt.show()
