...
# %%
df = pd.read_excel('journal_year_percent.xlsx',index_col=0)
...
cax = fig.add_axes([
    ...
    center_y - cax_height/2 + 0.1, # 垂直居中
    cax_width,
    cax_height
])
...
cbar.set_label('Percentage', fontsize=12, labelpad=12)
...
# 保存和显示
plt.tight_layout()
plt.savefig('ring_chart_percent.png', dpi=300, bbox_inches='tight')
plt.show()
